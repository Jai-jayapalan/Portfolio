...
const EmailSection = () => {
  ...
  return (
    <section className='grid relative md:grid-cols-2 my-12 md:my-12 py-24 gap-4' id='contact'>
        <div className='bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-purple-900 to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -left-4 transform -translate-x-1/2 -translate-1/2'></div>
        <div className='z-10'>
            <h5 className='text-xl font-bold text-white my-2'>Let's Connect</h5>
            <p className='text-[#ADB7BE] mb-4 max-w-md'>
            A dedicated section inviting visitors to reach out and connect. This area includes engaging text 
            and a call to action, encouraging interaction while maintaining a professional and approachable tone.
            </p>
            <div className='socials flex flex-row gap-2'>
              <Link href={'https://github.com/Jai-jayapalan'}>
                <Image alt='summa' src={GithubIcon} width={50} height={50}/>
              </Link>
              <Link href={'https://www.linkedin.com/in/jai-jayathilak/'}>
                <Image alt='summa' src={LinkedinIcon} width={50} height={50}/>
              </Link>
              <Link href={'https://www.instagram.com/jai_jayathilak?utm_source=qr'}>
                <Image alt='summa' src={InstaIcon} width={50} height={50}/>
              </Link>
            </div>
        </div>
        <div>
